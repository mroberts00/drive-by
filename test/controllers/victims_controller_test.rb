...
class VictimsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create victim" do
    assert_difference('Victim.count') do
      post victims_url, params: { victim: { age: @victim.age, dead: @victim.dead, name: @victim.name } }
    end
  ...
  test "should update victim" do
    patch victim_url(@victim), params: { victim: { age: @victim.age, dead: @victim.dead, name: @victim.name } }
